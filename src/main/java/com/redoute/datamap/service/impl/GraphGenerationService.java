 ...
 */
@Service
public class GraphGenerationService implements IGraphGenerationService {
    ...
    public BufferedImage generateBarChart(CategoryDataset categorydataset, String name, int i, Color color) {
        ...
        JFreeChart jfreechart = ChartFactory.createBarChart(name, "Category", "Value", categorydataset, PlotOrientation.VERTICAL, false, true, false);
        CategoryPlot categoryplot = (CategoryPlot) jfreechart.getPlot();
        NumberAxis numberaxis = (NumberAxis) categoryplot.getRangeAxis();
        numberaxis.setStandardTickUnits(NumberAxis.createIntegerTickUnits());
...
//               
            ...
            Logger.getLogger(GraphGenerationService.class.getName()).log(Level.SEVERE, null, ex);
        }
